...
jQuery(document).ready(function() {
	...
	jQuery("#stksum").validate({
		...
		submitHandler: function(){var fmt = jQuery("select#format").val();
								  var url="/mms/report/STKSUM/"+fmt+"?"+jQuery("#stksum").serialize();
					   			  openReport(url,'Stock summary by Date');
					   			 } 
	});
});
</script>
<div id="div" align="center">	
	<form id="stksum" method="post">
	<table id="ver-zebra" width="100%">
		...
		<thead>
			<tr>
				<th scope="col" colspan="2" align="center" id="zebra-adventure">Stock Summary by Date</th>								
			</tr>
		</thead>
		<tbody>
			<tr>
