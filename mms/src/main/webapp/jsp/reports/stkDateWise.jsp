...
jQuery(document).ready(function() {
	...
	jQuery("#stkDateWise").validate({
		...
		submitHandler: function(){var fmt = jQuery("select#format").val();
								  var url="/mms/report/STKDate/"+fmt+"?"+jQuery("#stkDateWise").serialize();
					   			  openReport(url,'Stock by Date');
					   			 } 
	});
});
</script>
<div id="div" align="center">	
	<form id="stkDateWise" method="post">
	<table id="ver-zebra" width="100%">
		...
		<thead>
			<tr>
				<th scope="col" colspan="2" align="center" id="zebra-adventure">Stock By Date</th>								
			</tr>
		</thead>
		<tbody>
			<tr>
