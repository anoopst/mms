...
jQuery(document).ready(function() {
	...
	jQuery("#poVenWise").validate({
		...
		submitHandler: function(){var fmt = jQuery("select#format").val();
								  var url="/mms/report/POVEN/"+fmt+"?"+jQuery("#poVenWise").serialize();
					   			  openReport(url,'PO by Vendor');
					   			 } 
	});
});
</script>
<div id="div" align="center">	
	<form id="poVenWise" method="post">
	<table id="ver-zebra" width="100%">
		...
		<thead>
			<tr>
				<th scope="col" colspan="2" align="center" id="zebra-adventure">PO By Vendor</th>								
			</tr>
		</thead>
		<tbody>
			<tr>
