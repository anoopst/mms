...
jQuery(document).ready(function() {
	...
	jQuery("#poDateWise").validate({
		...
		submitHandler: function(){var fmt = jQuery("select#format").val();
								  var url="/mms/report/PODate/"+fmt+"?"+jQuery("#poDateWise").serialize();
					   			  openReport(url,'PO by Date');
					   			 } 
	});
});
</script>
<div id="div" align="center">	
	<form id="poDateWise" method="post">
	<table id="ver-zebra" width="100%">
		...
		<thead>
			<tr>
				<th scope="col" colspan="2" align="center" id="zebra-adventure">PO By Date</th>								
			</tr>
		</thead>
		<tbody>
			<tr>
