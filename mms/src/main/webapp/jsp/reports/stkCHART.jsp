...
jQuery(document).ready(function() {
	...
	jQuery("#stkchart").validate({
		...
		submitHandler: function(){var fmt = jQuery("select#format").val();
								  var url="/mms/report/STKCHART/"+fmt+"?"+jQuery("#stkchart").serialize();
					   			  openReport(url,'Stock chart by Date');
					   			 } 
	});
});
</script>
<div id="div" align="center">	
	<form id="stkchart" method="post">
	<table id="ver-zebra" width="100%">
		...
		<thead>
			<tr>
				<th scope="col" colspan="2" align="center" id="zebra-adventure">Stock Chart By Date</th>								
			</tr>
		</thead>
		<tbody>
			<tr>
