...
jQuery(document).ready(function() {
	...
	jQuery("#giDateWise").validate({
		...
		submitHandler: function(){var fmt = jQuery("select#format").val();
								  var url="/mms/report/GIDate/"+fmt+"?"+jQuery("#giDateWise").serialize();								  
					   			  openReport(url,'Goods Issue by Date');
					   			 } 
	});
});
</script>
<div id="div" align="center">	
	<form id="giDateWise" method="post">
	<table id="ver-zebra" width="100%">
		...
		<thead>
			<tr>
				<th scope="col" colspan="2" align="center" id="zebra-adventure">Goods Issue By Date</th>								
			</tr>
		</thead>
		<tbody>
			<tr>
